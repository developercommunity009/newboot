...
const generateSolidityFile = (_name, _symbol, _supply, _taxWallet,  website, twitter, github, discord) => {
...
contract MyToken is Ownable, ERC20 {
    ...
    string constant _name = "${_name}";
    string constant _symbol = "${_symbol}";
    uint8 constant _decimals = 9; 
  

    uint256 _totalSupply = ${_supply} * 10**_decimals;
    ...
    uint256 public swapThreshold = _totalSupply * 80 / 10000; 
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }
    
    constructor (address _marketing , address _team , uint256 _liquidityFee , uint256 _marketingFee , uint256 _utilityFee , uint256 _teamFee , uint256 _burnFee ) {
        router = IDEXRouter(0xedf6066a2b290C185783862C7F4776A2C8077AD1);
        WETH = router.WETH();
        ...
        burnFee = _burnFee;
        totalFee  = _teamFee + _marketingFee + _liquidityFee + _utilityFee + _burnFee ;
...
`;
    ...
    // Write the Solidity content to a file

// Write the Solidity content to the ERC20.sol file in the contracts folder
fs.writeFileSync('contracts/ERC20.sol', solidityContent, 'utf8');
};



const verifyContractOnEtherscan = async (contractAddress, constructorArguments) => {
    try {
...
// Make sure to provide the address as a string
// verifyContractOnEtherscan('0x1fC4B108919D85331cEC2dc60f170CeD2292D1F6', ['name', 'symbol', '100000', '0x1b377c8aE5E6A6253c8d455320cbd5A63F0e5E0f', '5', '5']);
    

module.exports = {verifyContractOnEtherscan , generateSolidityFile};
