...
const {  getWalletById, updateWallet, deleteWallet,generateWallets, getWalletsByUserId, enableTradingAndBuyToken, generateMainWallet, autoFundingToSubWallets, enableTradingAndSellToken  } = require('../controllers/walletController');
